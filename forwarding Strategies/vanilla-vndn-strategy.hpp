 ...
 */
class NativeVndnStrategy : public Strategy
                         , public ProcessNackTraits<NativeVndnStrategy>
{
public:
  NativeVndnStrategy(Forwarder& forwarder, const Name& name = getStrategyName());

  virtual
  ~NativeVndnStrategy() override;
...
friend ProcessNackTraits<NativeVndnStrategy>;
