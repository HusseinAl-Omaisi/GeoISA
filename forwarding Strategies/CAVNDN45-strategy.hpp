 ...
 */
class AngleSuppressionStrategy : public Strategy
                         , public ProcessNackTraits<AngleSuppressionStrategy>
{
public:
  AngleSuppressionStrategy(Forwarder& forwarder, const Name& name = getStrategyName());

  virtual
  ~AngleSuppressionStrategy() override;
...
friend ProcessNackTraits<AngleSuppressionStrategy>;
